...
public class Test1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Marks Percentage");
...
"jdbc:mysql://localhost:3306/neharika","root","");  
 ...
 String h0=jTextField6.getText(); 
String h1=jTextField1.getText();
String h2=jTextField2.getText();
String h3=jTextField3.getText();
String h4=jTextField4.getText();
String h5=jTextField5.getText();
...
int rs = stmt.executeUpdate("insert into marks(Roll,Eng,Math,Phy,Chem,Bio)values('"+h0+"','"+h1+"','"+h2+"','"+h3+"','"+h4+"','"+h5+"')");   
